...
namespace Fxcjahid\LaravelAssetsManager\Foundation\Asset\Pipeline;
...
class FleetCartAssetPipeline implements AssetPipeline
{
     ...
     *
     * @param \Fxcjahid\LaravelAssetsManager\Foundation\Asset\Manager\AssetManager $assetManager
     */
